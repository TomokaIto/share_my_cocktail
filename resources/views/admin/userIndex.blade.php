...
<div class="d-flex align-items-center justify-content-center">
    <div class="flash_message bg-success text-center py-3 my-0 w-25">
    ...
    <div class="col-8 mt-5">
        ...
        <div>
            <div class="card bg-transparent border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-center">
                        <h4 class="card-title text-center text-light w-25 mb-3 p-2 rounded" style="background-color: rgba(128, 128, 128, 0.8);">ユーザ一覧</h4>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="/userDelete/{{$user->id}}">
                                                    {{ csrf_field() }}
                                                    <button type="submit" class="btn btn-outline-dark" onClick="delete_alert(event);return false;"><i class="fas fa-trash-alt mr-1"></i>削除</button>
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
